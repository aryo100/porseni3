<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="clearfix">
				<a class="btn btn-primary btn-xs" type="button" name="button" href="<?php echo base_url();?>index.php/admin/add_berita">Tambah data</a>
				...
				<tbody>
					...
					foreach ($sql1 as $obj1) {
						...
						<tr>
							...
							<td><?php echo $obj1->content; ?></td>
							<td><?php echo $obj1->status; ?></td>
							<td>
								<div class="hidden-sm hidden-xs action-buttons">
									<a class="green" href="<?php echo base_url();?>index.php/admin/berita_edit/<?php echo $obj1->id_berita;?>">
										<i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>
									</a>
									<a class="red" href="javascript:if(confirm('Apakah Anda yakin ingin menghapus ?')){document.location='<?php echo base_url();?>index.php/admin/berita_hapus/<?php echo $obj1->id_berita;?>';}">
