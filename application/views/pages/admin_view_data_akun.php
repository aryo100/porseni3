<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="clearfix">
				<a class="btn btn-primary btn-xs" type="button" name="button" href="<?php echo base_url();?>index.php/admin/add_akun">Tambah data</a>
					...
					foreach ($sql1 as $obj1) {
						...
						<tr>
							...
							<td>
								...
								<?php if($obj1->status != 'admin'){ ?>
									<a class="green" href="<?php echo base_url();?>index.php/admin/akun_edit/<?php echo $obj1->id_akun;?>">
										<i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>
									</a>
									<a class="red" href="javascript:if(confirm('Apakah Anda yakin ingin menghapus ?')){document.location='<?php echo base_url();?>index.php/admin/akun_hapus/<?php echo $obj1->id_akun;?>';}">
