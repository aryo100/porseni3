<div class="page-content">
						...
						<tr>
							...
							<td>
								<div class="hidden-sm hidden-xs action-buttons">
									<a class="blue" href="<?php echo base_url();?>index.php/admin/atlet_data_lengkap/<?php echo $obj1->id_atlet.'/'.$obj1->pt;?>">
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/2.3.0/jszip.min.js"></script>
